...
void curTimeDate(char *time2Print)
{
	char wday[][3]={{'S','u','n'}, {'M','o','n'}, {'T','u','e'}, {'W','e','d'},
                    {'T','h','u'}, {'F','r','i'}, {'S','a','t'},};
	...
	if(((int)(day/10.0))==0 || ((int)(day/10.0))==2 || ((int)(day/10.0))==3)
	{
		...
		{
			case 1:
				time2Print[12]='s';time2Print[13]='t';break;
			case 2:
				time2Print[12]='n';time2Print[13]='d';break;
			case 3:
				time2Print[12]='r';time2Print[13]='d';break;
			default:
				time2Print[12]='t';time2Print[13]='h';break;
		}
	}
